...
*/
    ...
    cb.calculate_rops(0.05);


    compute_compressed_rops_from_ROPS( cb.histograms1, cb.compressed_shot1, m, n, grids, bins);
    compute_compressed_rops_from_ROPS( cb.histograms2, cb.compressed_shot2, m, n, grids, bins);
