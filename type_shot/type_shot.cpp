...
// Special thanks to Yuriy Reznik for providing code for type coding
...
//Please choose the parameters based on the experimental results reported in the paper 
    ...
    grids = 16;// grids = dimension of the descriptor/bins, i.e., 352/22 = 16
...
*/
    ...
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> single_color1(cb.cloud1.makeShared(), 0, 240, 240);
    viewer->addPointCloud<pcl::PointXYZ> (cb.cloud1.makeShared(), single_color1, "sample cloud1");
    viewer->setPointCloudRenderingProperties (pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 1, "sample cloud1");
    //viewer->addCoordinateSystem (1.0);
    viewer->initCameraParameters ();

    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> single_color11(cb.cloud1_keypoints.makeShared(), 200, 0, 0);
    viewer->addPointCloud<pcl::PointXYZ> (cb.cloud1_keypoints.makeShared(), single_color11, "sample cloud11");
    viewer->setPointCloudRenderingProperties (pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 4, "sample cloud11");
    ...
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> single_color22(cb.cloud2_keypoints.makeShared(), 0, 0, 150);
    viewer->addPointCloud<pcl::PointXYZ> (cb.cloud2_keypoints.makeShared(), single_color22, "sample cloud22");
    viewer->setPointCloudRenderingProperties (pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 4, "sample cloud22");

    //int v2(1);
    //viewer->createViewPort (0.5,0.0,0.1,1.0,1);
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> single_color2(cb.cloud2.makeShared(), 255, 255, 255);
